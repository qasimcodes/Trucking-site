...
<section className="text-gray-600 body-font relative">
  ...
  <div className="container px-5 py-24 mx-auto flex">
    <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
      <h2 className="text-gray-900 font-serif text-lg mb-1 font-medium title-font">Contact US</h2>
      <p className="leading-relaxed mb-5 text-gray-600">Feel free to contact us. </p>
      <div className="relative mb-4">
        <label htmlFor="email" className="leading-7 font-serif text-sm text-gray-600">Email</label>
        <input type="email" id="email" name="email" className="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
      </div>
      <div className="relative mb-4">
        <label htmlFor="message" className="leading-7 font-serif text-sm text-gray-600">Message</label>
      ...
      <button className="text-white bg-gray-900 border-0 py-2 px-6 focus:outline-none hover:bg-gray-800 rounded text-lg">Submit</button>
      <p className="text-xs text-gray-500 mt-3">Our Representative will contact you within 2 hours.</p>
    </div>
  </div>
</section>
